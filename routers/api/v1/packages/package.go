...
func ListPackages(ctx *context.APIContext) {
	...
	//   type: string
	//   enum: [alpine, apex, arch, cargo, chef, composer, conan, conda, container, cran, debian, fdroid, generic, go, helm, maven, npm, nuget, pub, pypi, rpm, alt, rubygems, swift, vagrant]
	// - name: q
	//   in: query
